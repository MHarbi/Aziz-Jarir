...
<div class="products-colors-view">
    ...
    <div class="row">
        <div class="col-sm-9">
            <h2><?= 'Products Colors'.' '. Html::encode($this->title) ?></h2>
        </div>
        <div class="col-sm-3" style="margin-top: 15px">
            ...
            <?= Html::a('Update', ['update', 'product_id' => $model->product_id, 'color' => $model->color], ['class' => 'btn btn-primary']) ?>
            <?= Html::a('Delete', ['delete', 'product_id' => $model->product_id, 'color' => $model->color], [
                'class' => 'btn btn-danger',
                'data' => [
