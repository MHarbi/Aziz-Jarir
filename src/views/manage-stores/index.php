...
/* @var $searchModel app\models\ManageStoresSearch */
...
?>
<div class="manage-stores-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a('Create Manage Stores', ['create'], ['class' => 'btn btn-success']) ?>
    ...
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Salespersons', 'id' => 'grid-manage-stores-search-ssn']
            ],
        [
                'attribute' => 'store_id',
                'label' => 'Store',
                ...
                'filterInputOptions' => ['placeholder' => 'Stores', 'id' => 'grid-manage-stores-search-store_id']
            ],
        'since',
        [
