...
/* @var $model app\models\FullProducts */
 ...
 if($this->title != 'Search results') $this->title = isset($_GET['brand']) ? $_GET['brand'] : 'All Products';
if(isset($_GET['brand'])) $this->params['breadcrumbs'][] = ['label' => 'All Brands', 'url' => ['full-products/index']];
